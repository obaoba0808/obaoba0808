...
## 🌍 Travel & Digital Projects

I build **budget travel guides** and **local service platforms** for the Asian market.

### 🚀 Active Projects

| Project | Description | Link |
|---------|-------------|------|
| **均在路上 Travel Lab** | Budget travel guides for Japan, Korea, Taiwan & Southeast Asia | [golightly.fun](https://golightly.fun/) |
...
- **SEO**: Schema.org JSON-LD, structured data, content marketing
- **Analytics**: GA4, Google Search Console

### 📊 What I Do

- 🔍 **SEO Optimization** — Technical audits, keyword research, content strategy
- ✍️ **Content Marketing** — Long-form travel guides, local service content
- 🤝 **Affiliate Marketing** — Agoda, Klook, Booking.com integrations
- 🏗️ **Web Development** — Responsive, mobile-first, fast-loading sites

---

*Visit [Travel Lab](https://golightly.fun/) for free budget travel guides to Japan, Korea, Taiwan, and Southeast Asia.*
